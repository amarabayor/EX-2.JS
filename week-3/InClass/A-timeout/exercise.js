...
// another method for task one.
// let PgColor =document.querySelector("#main");
// let BtnChangeBackgroundColor =document.getElementById("text");
// BtnChangeBackgroundColor =addEventListener("click", function(){
//     setTimeout(function(){
//         PgColor.style.backgroundColor = "red";
//},5000);
// });
